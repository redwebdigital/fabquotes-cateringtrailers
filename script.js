...
function renderTrailers() {
  ...
  grid.innerHTML = state.trailers.map(t => `
    <button class="trailer-btn${state.selectedTrailerId === t.id ? ' selected' : ''}" data-id="${t.id}">
      <div class="trailer-btn-icon"><img src="trailer-icon.png" style="width:60px;height:auto;margin-bottom:6px" /><img src="trailer-icon.png" style="width:60px;height:auto;margin-bottom:6px" /></div>
